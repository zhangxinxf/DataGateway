...
public class PageInterceptor implements Interceptor {
    ...
    public Object intercept(Invocation invocation) throws Throwable {
        ...
        if (mappedStatement.getId().matches(pageSqlId)) {
            ...
            if (parameterObject == null) {
                ...
                PageBean page = (PageBean) metaStatementHandler
    ...
    private void setPageParameter(String sql, Connection connection, MappedStatement mappedStatement,
        ...
        try {
            ...
            int totalPage = totalCount / page.getPerPage() + ((totalCount % page.getPerPage() == 0) ? 0 : 1);
    ...
    public StringBuilder buildPageSqlForMysql(String sql, PageBean page) {
        ...
        String beginrow = String.valueOf((page.getIndex()- 1) * page.getPerPage());
        pageSql.append(sql);
        pageSql.append(" limit " + beginrow + "," + page.getPerPage());
        return pageSql;
    }
    ...
    public StringBuilder buildPageSqlForOracle(String sql, PageBean page) {
        StringBuilder pageSql = new StringBuilder(100);
        String beginrow = String.valueOf((page.getIndex() - 1) * page.getPerPage());
        String endrow = String.valueOf(page.getIndex() * page.getPerPage());
