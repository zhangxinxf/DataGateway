...
var dbinfoCheck = {
		rules: {
			appname: {
				...
				remote:{ // 验证应用名称是否存在
					　　 type:"GET",
					　　 url:rootPath+"/dbinfo/checkName",
					　　 data:{
					　　		appname:function(){return $("#appname").val();},
 ...
 * @returns
 */
function dbinfoActionConfirm(actionName,url,title,width,height){
	 var checkedCount = 0;
	 var checkedValue = "";
	 var idArray=new Array();
	 var options = {
	                success:dbinfoActionResponse,
	                timeout:3000
	               };
 ...
 * @param $form
 */
function dbinfoActionResponse(responseText, statusText, xhr, $form)  { 
	 $.msgBox({
		    title:"消息提示",
		    content:""+responseText.msg,
		    type:"info",
