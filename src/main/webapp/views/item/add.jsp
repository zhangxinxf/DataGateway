...
<body>
	<div class="p20">
		<form name=pageForm id="pageForm" action="<%=path%>/item/add"
			method="post">
			<div class="clearfix pop_input">
				<label for="input_suzhu"><span class="red mr10">*</span>指标名称：</label>
				<input type="text" name="itemName" id="itemName" maxlength="20"/> <input
			...
			<div class="clearfix pop_input">
				...
				<textarea rows="10" cols="10" id="itemDes" name="itemDes"></textarea>
			</div>
		</form>
