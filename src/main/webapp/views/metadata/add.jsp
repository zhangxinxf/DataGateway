...
<body>
	<div class="p20">
		<form name=pageForm id="pageForm" action="<%=path%>/metadata/add"
			method="post">
			<div class="clearfix pop_input">
				<label for="input_suzhu"><span class="red mr10">*</span>名称：</label>
				<input type="text" name="metadataName" id="metadataName" maxlength="20"/> <input
					type="hidden" id="id" value="0">
			</div>
			<div class="clearfix pop_input">
				<label for="input_suzhu">描述：</label>
				<textarea rows="10" cols="10" id="metadataDes" name="metadataDes"></textarea>
			</div>
		</form>
