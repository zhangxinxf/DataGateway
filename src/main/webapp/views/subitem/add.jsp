...
<body>
	<div class="p20">
		<form name=pageForm id="pageForm" action="<%=path%>/subitem/add"
			method="post">
			<div class="clearfix pop_input">
				<label for="input_suzhu"><span class="red mr10">*</span>字段名称：</label>
				<input type="text" name="fieldName" id="fieldName" maxlength="20" />
				<input type="hidden" id="id" value="0">
			</div>
			<div class="clearfix pop_input">
				<label for="input_suzhu"><span class="red mr10">*</span>字段类型：</label>
				<input type="text" name="dbType" id="dbType" maxlength="20" />
			</div>
			<div class="clearfix pop_input">
			...
			<div class="clearfix pop_input">
				...
				<textarea rows="10" cols="10" id="fieldDes" name="fieldDes"></textarea>
			</div>
		</form>
