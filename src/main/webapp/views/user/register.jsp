...
<body>
	<div class="p20">
		<form name=pageForm id="pageForm" action="<%=path%>/userinfo/register"
			method="post">
			<div class="clearfix pop_input">
				<label for="input_suzhu"><span class="red mr10">*</span>用户名：</label>
				<input type="text" name="loginName" id="loginName" maxlength="30" />
			...
			<div class="clearfix pop_input">
				...
				<input type="password" name="rePassWord" id="rePassWord" size="26"
					maxlength="20" />
			</div>
			<!-- <div class="clearfix pop_input">
		...
		<div class="clearfix pop_btn_group_center">
			<a href="javascript:{}" class="blue_btn left"
				onclick="saveOrUpdateInfo();">注册</a> <a href="javascript:{}"
